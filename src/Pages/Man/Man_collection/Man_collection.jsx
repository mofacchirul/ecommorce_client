...
import Man_useTan from '../Man_useTan/Man_useTan';
const Man_collection = () => {
    const [man, loading] =Man_useTan()
    ...
    return (
        ...
        <span className='uppercase text-transparent  text-bg-clip  bg-clip-text bg-gradient-to-r from-red-500 via-yellow-500 to-pink-500'>
            <Typewriter
                options={{
                    strings: ['Popular Man Collection'],
                    autoStart: true,
                    loop: true,
                }}
            />
